		...
		<table style="width: 883px; height: 122px; margin-top: 40px;">
			...
			<tr>
				...
				<td><a4j:outputPanel ajaxRendered="true">
					<rich:calendar id="arrivalDate" value="#{travelRequest.travelSettlement.arrivalDate}" datePattern="MM/dd/yy HH:mm">
					
					<a4j:support ajaxSingle="true" action="#{travelProcessor.computeDaysForSettlement}" event="onchanged" reRender="noOfDays" status="waitStatus"/>
						</rich:calendar>
				</a4j:outputPanel></td>
			</tr>
			<tr>
				...
				<td><h:inputText id="department"
					value="#{travelRequest.employee.department}" readonly="true">
				</h:inputText></td>
				<td>Date of Submission *</td>
				<td><a4j:outputPanel ajaxRendered="true">
					<rich:calendar rendered="#{loginBean.role!='finance'}" id="submissionDate" value="#{travelRequest.travelSettlement.submissionDate}" datePattern="MM/dd/yy" >
					</rich:calendar>
				</a4j:outputPanel></td>
			</tr>
			<tr>
			...
			<h:column>
				<f:facet name="header">
					...
					<rich:calendar id="lodgingDate"
						value="#{lodging.date}"
						datePattern="MM/dd/yy" disabled="#{loginBean.role=='finance'}">
					</rich:calendar>
				</a4j:outputPanel>	
			</h:column>
			<h:column>
		...
		<rich:dataTable id="travellingTable" value="#{travelRequest.travelSettlement.travelingDailyAllowanceExpenses}" var="travelling" bgcolor="#F1F1F1" border="10" cellpadding="5" cellspacing="3" first="0" rows="0" dir="LTR" frame="box" rules="all" style="width:883px; margin-top:40px;">
			...
			<h:column>
				<f:facet name="header">
					...
					<h:inputText id="travelingDailyAllowanceNoOfDays" value="#{travelRequest.travelSettlement.noOfDays}" disabled="#{loginBean.role=='finance'}">
						<f:convertNumber type="number"/>
					</h:inputText>					
			</h:column>
			<h:column>
