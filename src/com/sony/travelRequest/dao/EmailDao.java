...
import com.sony.travelRequest.model.Email;

/**
 * Home object for domain model class Email.
 * @see com.sony.travelRequest.model.Email
...
//	}
	...
	public Email merge(Email detachedInstance) {
		...
		try {
			Email result = (Email) getHibernateTemplate().merge(detachedInstance);
	...
	public Email findById(java.lang.String id) {
		log.debug("getting Email instance with id: " + id);
		try {
			Email instance = (Email) getHibernateTemplate().get("com.sony.travelRequest.model.Email", id);
			if (instance == null) {
...
//		try {
//			List<Email> results = (List<Email>) sessionFactory
//					.getCurrentSession().createCriteria(
//							"com.sony.travelRequest.model.Email").add(
